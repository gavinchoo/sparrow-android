package com.sparrow.bundle.framework.utils.qmui;
...
/**
 * 沉浸式使用：  QMUIStatusBarHelper.setStatusBarLightAndStatusBarColor(this, );
 * @author cginechen
 * @date 2016-03-27
 */
...
//            }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (isMIUICustomStatusBarLightModeImpl() && MIUISetStatusBarLightMode(activity.getWindow(), false)) {
    ...
    public static boolean setStatusBarLightAndStatusBarColor(Activity activity, @ColorInt int colorOn5x) {
        boolean isChanged = setStatusBarLightMode(activity);
        if (isChanged && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
