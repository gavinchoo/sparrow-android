...
public class JsCallJava {
    ...
    private ArrayMap<String, Method> getAllMethod(Class injectedCls) {
    ...
    public JsCallResult call(WebView webView, String jsonStr) {
        String methodName = "";
        String name = BRIDGE_NAME;
        String param = "{}";
        JsCallResult result = null;
        String sid = "";
        ...
        if (!TextUtils.isEmpty(jsonStr)) {
            try {
                ...
                values[0] = webView;
                values[1] = null == param ? new JSONObject() : new JSONObject(param);
    ...
    private JsCallResult getReturn(String reqJson, int stateCode, Object result) {
        String insertRes;
        if (result == null) {
            insertRes = "null";
        ...
        JsCallResult result1 = new JsCallResult();
        result1.code = stateCode;
        result1.message = insertRes;
