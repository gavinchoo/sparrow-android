...
public class BubblePopupWindow extends PopupWindow {
     ...
     * @param gravity
     * @param bubbleOffset 气泡尖角位置偏移量。默认位于中间
     * @param popXOffset A horizontal offset from the anchor in pixels
     * @param popYOffSet A vertical offset from the anchor in pixels
     */
    public void show(View parent, int gravity, float bubbleOffset , int popXOffset , int popYOffSet ) {
        ...
        if (!this.isShowing()) {
            ...
            switch (gravity) {
                case Gravity.BOTTOM:
                    showAsDropDown(parent,popXOffset,popYOffSet);
                    break;
                case Gravity.TOP:
