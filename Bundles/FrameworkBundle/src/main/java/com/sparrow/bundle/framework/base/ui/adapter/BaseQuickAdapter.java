...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     */
    @Deprecated
    public void loadMoreEnd(final boolean gone) {
    ...
    public void isLoadMore(final boolean isLoad) {
        mLoading = false;
        int moreStatus = LoadMoreView.STATUS_DEFAULT;
        if (!isLoad) {
            moreStatus = LoadMoreView.STATUS_FAIL;
        }
        mLoadMoreView.setLoadMoreStatus(moreStatus);
    }
    ...
    /**
     * delete the item associated with the specified position of adapter
     *
     * @param position
     */
    ...
    public void addData(List<T> newData) {
        KLog.i("before_dataSize :" + mData.size());
        this.mData.addAll(newData);
        KLog.i("after_dataSize :" + mData.size());
...
//                }
    ...
    /**
     * delete header view from mHeaderLayout.
    ...
    /**
     * delete footer view from mFooterLayout,
    ...
    /**
     * delete all header view from mHeaderLayout and set null to mHeaderLayout
     */
    ...
    /**
     * delete all footer view from mFooterLayout and set null to mFooterLayout
     */
     ...
     * @param info   The item that needs to be displayed.
     */
    protected abstract void convert(K holder, T info, int position);
