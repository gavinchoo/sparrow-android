...
public class EditTextClear extends android.support.v7.widget.AppCompatEditText {
     ...
     */
    private void init() {
        clearDrawable = getResources().getDrawable(com.sparrow.bundle.framework.R.drawable.common_clear);
        searchDrawable = getResources().getDrawable(com.sparrow.bundle.framework.R.drawable.common_search);
