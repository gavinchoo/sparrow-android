 ...
 */
package com.sparrow.bundle.photo.matisse;
...
import com.sparrow.bundle.photo.matisse.ui.MatisseActivity;
...
import static com.sparrow.bundle.photo.matisse.internal.model.SelectedItemCollection.STATE_SELECTION;
...
public final class SelectionCreator {
     ...
     * 1. com.medical.bundle.photo.R.style.Matisse_Zhihu;
     * 2. com.medical.bundle.photo.R.style.Matisse_Dracula
     * you can define a custom theme derived from the above ones or other themes.
     *
     * @param themeId theme resource id. Default value is com.medical.bundle.photo.R.style.Matisse_Zhihu.
     * @return {@link SelectionCreator} for fluent API.
     */
    ...
    public SelectionCreator maxPhotoable(int maxPhotoable) {
        if (maxPhotoable < 1)
            throw new IllegalArgumentException("maxPhotoable must be greater than or equal to one");
        mSelectionSpec.maxPhotoable = maxPhotoable;
        return this;
    }
     ...
     * 1. {@link com.medical.bundle.photo.matisse.engine.impl.GlideEngine}
     ...
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator upload(boolean upload) {
        mSelectionSpec.upload = upload;
        return this;
    }

    public SelectionCreator uploadParams(UploadParams params) {
        mSelectionSpec.uploadParams = params;
        return this;
    }

    /**
     * show is need select original photo.
     * <p>
     *
     * @param selectOriginal
     * @return {@link SelectionCreator} for fluent API.
     */
    public SelectionCreator showSelectOriginal(boolean selectOriginal) {
        mSelectionSpec.selectOriginal = selectOriginal;
        return this;
    }
    ...
    public SelectionCreator saveDir(String saveDir) {
        mSelectionSpec.saveDir = saveDir;
        return this;
    }
    ...
    public void forResult(int requestCode) {
        ...
        if (null != mSelectionSpec.selectItems) {
            intent.putParcelableArrayListExtra(STATE_SELECTION, mSelectionSpec.selectItems);
        }
    ...
    public void forResultPreview(int requestCode, Bundle bundle) {
        Activity activity = mMatisse.getActivity();
        if (activity == null) {
            return;
        }
        ...
        intent.putExtra(SelectedPreviewActivity.EXTRA_DEFAULT_BUNDLE, bundle);
        Fragment fragment = mMatisse.getFragment();
        if (fragment != null) {
            fragment.startActivityForResult(intent, requestCode);
        } else {
