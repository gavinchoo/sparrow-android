...
import com.sparrow.bundle.photo.matisse.internal.ui.widget.MediaGrid;
import com.sparrow.bundle.photo.matisse.internal.entity.Album;
import com.sparrow.bundle.photo.matisse.internal.entity.IncapableCause;
import com.sparrow.bundle.photo.matisse.internal.entity.Item;
import com.sparrow.bundle.photo.matisse.internal.entity.SelectionSpec;
...
public class AlbumMediaAdapter extends
    ...
    public AlbumMediaAdapter(Context context, SelectedItemCollection selectedCollection, RecyclerView recyclerView) {
        ...
        TypedArray ta = context.getTheme().obtainStyledAttributes(new int[]{com.sparrow.bundle.photo.R.attr.item_placeholder});
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_CAPTURE) {
            View v = LayoutInflater.from(parent.getContext()).inflate(com.sparrow.bundle.photo.R.layout.photo_capture_item, parent, false);
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(com.sparrow.bundle.photo.R.layout.media_grid_item, parent, false);
    ...
    protected void onBindViewHolder(final RecyclerView.ViewHolder holder, Cursor cursor) {
        if (holder instanceof CaptureViewHolder) {
            ...
            TypedArray ta = holder.itemView.getContext().getTheme().obtainStyledAttributes(
                    new int[]{com.sparrow.bundle.photo.R.attr.capture_textColor});
    ...
    private int getImageResize(Context context) {
        if (mImageResize == 0) {
            ...
            int availableWidth = screenWidth - context.getResources().getDimensionPixelSize(
                    com.sparrow.bundle.photo.R.dimen.media_grid_spacing) * (spanCount - 1);
    ...
    private static class CaptureViewHolder extends RecyclerView.ViewHolder {
        ...
        CaptureViewHolder(View itemView) {
            ...
            mHint = itemView.findViewById(com.sparrow.bundle.photo.R.id.hint);
        }
    }
