...
//        canvas.drawColor(0xffff0000);
    ...
    public void startTypeBtnAnimator() {
        ...
        txt_complete.setVisibility(INVISIBLE);
...
//        btn_cancel_param.addRule(ALIGN_PARENT_LEFT, TRUE);
        ...
        btn_cancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                txt_complete.setVisibility(VISIBLE);
...
//        btn_return_param.addRule(CENTER_VERTICAL, TRUE);
        ...
        txt_complete = new TextView(getContext());
        txt_param = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        txt_param.gravity = Gravity.CENTER_VERTICAL;
        txt_param.setMargins((layout_width * 3 / 4), 0, 0, 0);
        txt_complete.setText("完成");
        txt_complete.setPadding(20, 20, 20, 20);
        txt_complete.setTextColor(0xFFFFFFFF);
        txt_complete.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
        txt_complete.setGravity(Gravity.CENTER);
        txt_complete.setLayoutParams(txt_param);
        txt_complete.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (typeLisenter != null) {
                    typeLisenter.mulitConfirm();
                }
            }
        });
        ...
        if (SelectionSpec.getInstance().mulitPhoto) {
            this.addView(txt_complete);
        }
    }
