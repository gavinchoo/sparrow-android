 ...
 */
package com.sparrow.bundle.photo.matisse.internal.model;
...
public class SelectedItemCollection {
    ...
    public static final String STATE_SELECT_POSITION = "state_selection_position";
    public static final String STATE_COLLECTION_TYPE = "state_collection_type";
    public static final String STATE_ORIGINAL_STATUS = "state_original_selected";
    /**
     * Empty collection
     */
    ...
    public void onCreate(Bundle bundle) {
        if (bundle == null) {
            ...
            isOriginalSelected = bundle.getBoolean(STATE_ORIGINAL_STATUS);
        }
    }
    ...
    public Bundle getDataWithBundle() {
        ...
        bundle.putBoolean(STATE_ORIGINAL_STATUS, isOriginalSelected);
        return bundle;
    }

    public void setOriginalSelected(boolean originalSelected) {
        isOriginalSelected = originalSelected;
    }

    public boolean isOriginalSelected() {
        return isOriginalSelected;
    }
        ...
        if (maxSelectableReached()) {
            ...
            try {
                cause = mContext.getResources().getString(
                        com.sparrow.bundle.photo.R.string.error_over_count,
                        maxSelectable
                );
            ...
            return new IncapableCause(mContext.getString(com.sparrow.bundle.photo.R.string.error_type_conflict));
        }
    ...
    public String totalStrSize() {
        return PhotoMetadataUtils.getSizeInMB(totalSize()) + "MB";
    }
