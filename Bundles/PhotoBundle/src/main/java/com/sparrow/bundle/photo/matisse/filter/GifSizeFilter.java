 ...
 */
package com.sparrow.bundle.photo.matisse.filter;
...
public class GifSizeFilter extends Filter {
    ...
    public IncapableCause filter(Context context, Item item) {
        ...
        if (size.x < mMinWidth || size.y < mMinHeight || item.size > mMaxSize) {
            return new IncapableCause(IncapableCause.DIALOG, context.getString(com.sparrow.bundle.photo.R.string.error_gif, mMinWidth,
