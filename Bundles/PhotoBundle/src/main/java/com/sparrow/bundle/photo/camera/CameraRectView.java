...
//        viewHeight = panelHeght - (int) DisplayUtil.dp2px(activity,TOP_BAR_HEIGHT + BOTTOM_BTN_HEIGHT);
        ...
        rectWidth = panelWidth - dp2px(activity, LEFT_PADDING + RIGHT_PADDING);
...
//        canvas.drawRect(rect, wordPaint);
    ...
    public int getRectWidth() {
        return Math.abs(rectLeft - rectRight);
    }

    public int getRectHeight() {
        return Math.abs(rectTop - rectBottom);
    }
