package com.sparrow.bundle.photo.matisse.internal.ui.widget;
...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, com.sparrow.bundle.photo.R.styleable.CircleProgressBar);

        mBackgroundColor = a.getColor(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_background_color, Color.TRANSPARENT);

        mDrawProgressText = a.getBoolean(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_draw_progress_text, true);

        mLineCount = a.getInt(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_line_count, DEFAULT_LINE_COUNT);
        mProgressTextFormatPattern = a.hasValue(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_text_format_pattern) ?
                a.getString(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_text_format_pattern) : DEFAULT_PATTERN;

        mStyle = a.getInt(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_style, LINE);
        mShader = a.getInt(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_shader, LINEAR);
        mCap = a.hasValue(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_stroke_cap) ?
                Paint.Cap.values()[a.getInt(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_stroke_cap, 0)] : Paint.Cap.BUTT;

        mLineWidth = a.getDimensionPixelSize(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_line_width, dip2px(getContext(), DEFAULT_LINE_WIDTH));
        mProgressTextSize = a.getDimensionPixelSize(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_text_size, dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_stroke_width, dip2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));

        mProgressStartColor = a.getColor(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_start_color, Color.parseColor(COLOR_FFF2A670));
        mProgressEndColor = a.getColor(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_end_color, Color.parseColor(COLOR_FFF2A670));
        mProgressTextColor = a.getColor(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_text_color, Color.parseColor(COLOR_FFF2A670));
        mProgressBackgroundColor = a.getColor(com.sparrow.bundle.photo.R.styleable.CircleProgressBar_progress_background_color, Color.parseColor(COLOR_FFD3D3D5));
