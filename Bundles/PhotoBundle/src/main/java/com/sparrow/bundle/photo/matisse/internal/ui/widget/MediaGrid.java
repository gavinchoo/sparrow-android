...
public class MediaGrid extends SquareFrameLayout implements View.OnClickListener {
    ...
    private void init(Context context) {
        LayoutInflater.from(context).inflate(com.sparrow.bundle.photo.R.layout.media_grid_content, this, true);

        mThumbnail = findViewById(com.sparrow.bundle.photo.R.id.media_thumbnail);
        mCheckView = findViewById(com.sparrow.bundle.photo.R.id.check_view);
        mGifTag = findViewById(com.sparrow.bundle.photo.R.id.gif);
        mVideoDuration = findViewById(com.sparrow.bundle.photo.R.id.video_duration);
