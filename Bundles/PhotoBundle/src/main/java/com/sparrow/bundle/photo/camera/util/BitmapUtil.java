...
public class BitmapUtil {
    ...
    public static File saveBitMap(Context context, String filePath, final byte[] data, int rectLeft, int rectTop, int rectWidth, int rectHeight, boolean isNeedCut) {
    ...
    public static Bitmap cutBitMap(Bitmap photo, int rectLeft, int rectTop, int rectWidth, int rectHeight) {
        return Bitmap.createBitmap(photo, rectLeft, rectTop, rectWidth, rectHeight);
    }
